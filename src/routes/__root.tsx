...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aarkin — Government Scheme & Funding Advisory for Indian Founders" },
      {
        name: "description",
        content:
          "Aarkin helps Indian startups and MSMEs navigate grants, DPIIT recognition, Udyam registration and collateral-free loans.",
      },
      { name: "author", content: "Aarkin Advisory" },
      { property: "og:title", content: "Aarkin — Government Scheme & Funding Advisory" },
      {
